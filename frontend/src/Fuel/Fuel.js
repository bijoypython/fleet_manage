...
export default function Fuel() {
  ...
  const getFuel = () => {
    axios({
      method: "get",
      url: "http://localhost/fleet_manage/backend/Fuel",
      responseType: "json",
  ...
  useEffect(() => {
    ...
    axios({
      method: "get",
      url: "http://localhost/fleet_manage/backend/Fuel/getVehicle",
      responseType: "json",
    }).then(function (response) {
    ...
    axios({
      method: "get",
      url: "http://localhost/fleet_manage/backend/Fuel/getDriver",
      responseType: "json",
    }).then(function (response) {
  ...
  const save = () => {
    axios
      .post(
        "http://localhost/fleet_manage/backend/Fuel/addfuel",
        {
          vehicle_id: vehicle,
          driver_id: driver,
          fill_date: date,
  ...
  const deletefuel = (id) => {
    axios
      .post(
        "http://localhost/fleet_manage/backend/Fuel/deletefuel",
        {
          id: id,
        },
        {
