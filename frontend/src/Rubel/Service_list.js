...
export default function Service_list() {
    ...
    const getdata = () => {
        axios({
            method: 'get',
            url: 'http://localhost/fleet_manage/backend/Service/service_list',
            responseType: 'json'
    ...
    const deleteservice = (id)=>{
        axios.post('http://localhost/fleet_manage/backend/Service/deleteservice',{
            id:id
                                                    ...
                                                    <tbody>
                                                        {data.map((d, i) =>
                                                            <tr key={i}>
                                                                ...
                                                                <td>{d.title}</td>
                                                                <td><img
                                                                        src={`http://localhost/fleet_manage/backend/uploads/${d.photo}`}
                                                                        style={{ width: "100px", height: "80px" }}
                                                                    /></td>
                                                                <td><img
                                                                        src={`http://localhost/fleet_manage/backend/uploads/${d.icon}`}
                                                                        style={{ width: "100px", height: "80px" }}
                                                                    /></td>
                                                                <td>{d.descript}</td>
                                                                <td>
