...
const Reminder_car = () => {
    ...
    const getVehicle = () => {
        axios({
            method: 'get',
            url: 'http://localhost/fleet_manage/backend/Reminder/getvehicle',
            responseType: 'json'
    ...
    const save = () => {
        ...
        axios.post('http://localhost/fleet_manage/backend/Reminder/addreminder', {
            // role: role,
    ...
    const deletereminder = (id) => {
        axios.post('http://localhost/fleet_manage/backend/Customers/deletereminder', {
            id: id
        }, {
            headers: {
                'Content-Type': 'application/json',
