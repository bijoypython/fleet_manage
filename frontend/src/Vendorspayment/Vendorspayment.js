...
const navigate = useNavigate();
    ...
    useEffect(() => {
        axios({
            method: 'get',
            url: 'http://localhost/fleet_manage/backend/Vendorspayment/getVendorspayment',
            responseType: 'json'
    ...
    const save = () => {
        ...
        axios.post('http://localhost/fleet_manage/backend/vendorspayment/addvendorpayment', {
            vendor_id: vendorid,
            payment_date: date,
    ...
    //     axios.post('http://localhost/fleet_manage/backend/vendorspayment/deletemaintenance', {
    //         id: id
    //     },
    //         {
    //             headers: {
